# Papers TODO — Cancer-Targeting Peptides (Lung Cancer Focus)

Papers to read and summarize for the cancer peptides literature survey.
Scope: peptides that target, treat, or deliver drugs to lung cancer.
...
- [x] **Chi et al. (2017)** — Lung Cancer-Targeting Peptides with Multi-subtype Indication for Combinational Drug Delivery and Molecular Imaging
  - *Theranostics* | [PMC5436516](https://pmc.ncbi.nlm.nih.gov/articles/PMC5436516/)
  - Focus: HSP1/HSP2/HSP4 peptides via phage display, SCLC+NSCLC targeting, liposomal doxorubicin delivery, MRI imaging

- [x] **Karankar et al. (2025)** — Peptide-Driven Strategies Against Lung Cancer
